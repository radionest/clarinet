...
async def test_find_studies_unreachable_peer() -> None:
    """C-FIND against an unreachable host raises AssociationError (409 at the API)."""
...
async def test_get_study_unreachable_peer(tmp_path: Path) -> None:
    """C-GET against an unreachable host raises AssociationError (409 at the API)."""
    from dimsechord import AssociationError
...
async def test_move_study_unreachable_peer(tmp_path: Path) -> None:
    """C-MOVE study to an unreachable host raises AssociationError (409 at the API)."""
    from dimsechord import AssociationError
...
async def test_move_series_unreachable_peer(tmp_path: Path) -> None:
    """C-MOVE series to an unreachable host raises AssociationError (409 at the API)."""
    from dimsechord import AssociationError
