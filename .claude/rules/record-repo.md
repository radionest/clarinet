...
| `add_file_links(record, matched_files)` | Additive `set_files`: creates links only for unlinked definitions, existing links/checksums untouched; appends to `record.file_links` in memory |
