...
| `/api/records/{id}/user` | PATCH | 200 | Assign user. Admins assign anyone; a non-admin may only assign **themselves** to a record that is unassigned or already theirs (frontend auto-assign on open), else **403** |
