...
`test_conform_4d_layered_preserves_wide_dtype`, `tests/test_image.py:2945`).
...
- **GDCM already sorts ascending along the IOP normal for the overwhelming
  ...
  (`tests/test_image.py:1147`). This means the epoch's *visible* on-disk change
